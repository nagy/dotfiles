...
(defun nagy-dired-flake-underline ()
  ...
  (ov-set (rx ".png" eol) 'face 'modus-themes-intense-red)
  (ov-set (rx ".jpg" eol) 'face 'modus-themes-intense-red)
  (ov-set (rx ".jpeg" eol) 'face 'modus-themes-intense-red)
  (ov-set (rx "CHANGELOG.md" eol) 'face 'modus-themes-intense-yellow)
  (ov-set (rx "README.md" eol) 'face 'modus-themes-intense-yellow)
  (ov-set (rx "README.org" eol) 'face 'modus-themes-intense-yellow)
  (ov-set (rx "README.rst" eol) 'face 'modus-themes-intense-yellow)
  (ov-set (rx "README.txt" eol) 'face 'modus-themes-intense-yellow)
  (ov-set (rx "README.md" eol) 'face 'modus-themes-bold)
  (ov-set (rx "README.org" eol) 'face 'modus-themes-bold)
  (ov-set (rx "README.rst" eol) 'face 'modus-themes-bold)
  (ov-set (rx "README.txt" eol) 'face 'modus-themes-bold))
