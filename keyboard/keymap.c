...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_6x6(
        ...
        KC_DEL ,KC_CALC,KC_INT1,KC_INT2,KC_INT3,KC_INT4,                        KC_WSTP, KC_P7 , KC_P8 , KC_P9 ,KC_PMNS,KC_BRID,
    ...
    [_RAISE] = LAYOUT_6x6(
        ...
        _______,XXXXXXX,KC_CUT ,KC_UNDO,KC_AGIN,KC_STOP,                        KC_LNG4,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,XXXXXXX,_______,
