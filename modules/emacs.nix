...
in
{
  nixpkgs.overlays = [
    ...
    (import (fetchTarball {
      url = "https://github.com/nix-community/emacs-overlay/archive/160e167fee1bb84587aa7ba26005e974903490cc.tar.gz";
      sha256 = "sha256-pdiJ6QGnBYo8L1ePd32u2DH5/jDijE3YGf1TMebaIcU=";
    }))
  ];
